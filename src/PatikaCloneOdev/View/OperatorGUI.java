...
import PatikaCloneOdev.Model.Course;
...
public class OperatorGUI extends JFrame {
    ...
    public OperatorGUI(Operator operator){
        ...
        lbl_welcome.setText("HoÅŸgeldin : " + operator.getName());
        ...
        Object[] col_user_list = {"ID", "Ad Soyad" , "KullanÄ±cÄ± AdÄ±" , "Å�ifre" , "ÃœyelikTipi"};
        ...
        Object[] col_courseList= {"ID","Ders AdÄ±", "Programlama Dili", "Patika","EÄŸitmen"};
